...
} from "../../contracts/PermissionChecker";
...
export class PermissionChecker__factory {
  ...
  static createInterface(): PermissionCheckerInterface {
    return new utils.Interface(_abi) as PermissionCheckerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PermissionChecker {
    return new Contract(address, _abi, signerOrProvider) as PermissionChecker;
  }
}
