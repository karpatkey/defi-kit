...
export interface PermissionTrackerInterface extends utils.Interface {
  functions: {
...
export interface PermissionTracker extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PermissionTrackerInterface;
