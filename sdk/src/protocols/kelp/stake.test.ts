  ...
  describe("eth", () => {
    ...
    //   check balance of stETH -> check balance of rseth
      it("stake stETH", async () => {
        ...
        console.log("minRsETH = ", await kit.asMember.kelp.LRTWithdrawalManager.minRsEthAmountToWithdraw(contracts.mainnet.lido.stEth)) 
        console.log("getExpectedRsEthAmount = " a), 
        const a = await kit.asMember.kelp.LRTWithdrawalManager.getExpectedAssetAmount("0xae7ab96520DE3A18E5e111B5EaAb095312D7fE84", balance))
