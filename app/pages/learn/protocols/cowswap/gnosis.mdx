...
| Name               | Address                                                                                                                |
| :----------------- | :--------------------------------------------------------------------------------------------------------------------- |
| `GPv2VaultRelayer` | [0xC92E8bdf79f0507f65a392b0ab4667716BFE0110](https://gnosisscan.io/address/0xC92E8bdf79f0507f65a392b0ab4667716BFE0110) |
| `OrderSigner`      | [0x23dA9AdE38E4477b23770DeD512fD37b12381FAB](https://gnosisscan.io/address/0x23dA9AdE38E4477b23770DeD512fD37b12381FAB) |
| `ComposableCow`    | [0xfdaFc9d1902f4e0b84f65F49f244b32b31013b74](https://gnosisscan.io/address/0xfdaFc9d1902f4e0b84f65F49f244b32b31013b74) |
| `TWAP`             | [0x6cF1e9cA41f7611dEf408122793c358a3d11E5a5](https://gnosisscan.io/address/0x6cF1e9cA41f7611dEf408122793c358a3d11E5a5) |

**Other Deployments**

| Name                           | Address                                                                                                                |
| :----------------------------- | :--------------------------------------------------------------------------------------------------------------------- |
| `ExtensibleFallbackHandler`    | [0x2f55e8b20D0B9FEFA187AA7d00B6Cbe563605bF5](https://gnosisscan.io/address/0x2f55e8b20D0B9FEFA187AA7d00B6Cbe563605bF5) |
| `CurrentBlockTimestampFactory` | [0x23dA9AdE38E4477b23770DeD512fD37b12381FAB](https://gnosisscan.io/address/0x23dA9AdE38E4477b23770DeD512fD37b12381FAB) |
...
| :------------ | :-------------------- | :-------------------------------------------------------------------- |
| `sell`        | _string[] (required)_ | XDAI \| `Token` address                                               |
| `buy`         | _string[] (optional)_ | XDAI \| `Token` address                                               |
...
<Callout type="info">
  To allow XDAI as `sell` or `buy` token, either the "XDAI" literal or the
...
<Callout type="info">
  `RECEIVER` below refers to the address that will receive the output tokens
  from the TWAP Order.
</Callout>
...
Approve `GPv2VaultRelayer` to spend `WXDAI` tokens on behalf of the avatar.
...
Deposit XDAI and receive `WXDAI` tokens.

- **Contract:** `WXDAI`
- **Function:** `deposit()` Ξ _allow sending XDAI_
...
<Callout type="info">
  The `signOrder` function does not allow sending XDAI. Therefore, XDAI must be
