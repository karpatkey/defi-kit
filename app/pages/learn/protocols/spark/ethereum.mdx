...
| `spETH`                 | [0xfE6eb3b609a7C8352A241f7F3A21CEA4e9209B8f](https://etherscan.io/address/0xfE6eb3b609a7C8352A241f7F3A21CEA4e9209B8f) |
| `spUSDC`                | [0x28B3a8fb53B741A8Fd78c0fb9A6B2393d896a43d](https://etherscan.io/address/0x28B3a8fb53B741A8Fd78c0fb9A6B2393d896a43d) |
| `spUSDT`                | [0xe2e7a17dFf93280dec073C995595155283e3C372](https://etherscan.io/address/0xe2e7a17dFf93280dec073C995595155283e3C372) |
...
#### `WETH · approve - spETH as spender`

Approve `spETH` to spend `WETH` tokens on behalf of the avatar.
...
- **Function:** `approve(address,uint256)`
  ...
  | Parameter | Constraint        |
  | :-------- | :---------------- |
  | `spender` | equal to `spETH` |
  | `amount`  | -                 |

#### `spETH · deposit`

Deposit `WETH` and receive `spETH` tokens in exchange.
...
Redeem `spETH` and withdraw `WETH` tokens.
...
#### `USDT · approve - spUSDC as spender`

Approve `spUSDC` to spend `USDC` tokens on behalf of the avatar.
...
- **Function:** `approve(address,uint256)`
  ...
  | Parameter | Constraint        |
  | :-------- | :---------------- |
  | `spender` | equal to `spUSDC` |
  | `amount`  | -                 |

#### `spUSDC · deposit`

Deposit `USDC` and receive `spUSDC` tokens in exchange.
...
Redeem `spUSDC` and withdraw `USDC` tokens.
...
#### `USDT · approve - spUSDT as spender`

Approve `spUSDT` to spend `USDT` tokens on behalf of the avatar.
...
- **Function:** `approve(address,uint256)`
  ...
  | Parameter | Constraint        |
  | :-------- | :---------------- |
  | `spender` | equal to `spUSDT` |
  | `amount`  | -                 |

#### `spUSDT · deposit`

Deposit `USDT` and receive `spUSDT` tokens in exchange.
...
Redeem `spUSDT` and withdraw `USDT` tokens.
