...
<Callout type="info">
  `TARGET` below refers to each element given in `targets` and has the following attributes:<br/>
  &nbsp;&nbsp;&nbsp;&nbsp;\{<br/>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'TARGET_NAME': `bpt` symbol<br/>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'TARGET_BPT': `bpt` address<br/>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'TARGET_ID': Aura pool id<br/>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'TARGET_REWARDER': `auraBaseRewardPool` address<br/>
  &nbsp;&nbsp;&nbsp;&nbsp;\}
</Callout>
