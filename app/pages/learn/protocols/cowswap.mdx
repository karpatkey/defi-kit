...
| `fee_amount_bp` | _int[] (optional)_    | Fee amount basis points (0-10000), where 0 is 0% and 10000 is 100% |
...
<Callout type="info">
  ...
  `fee_amount_bp`. It accepts a value between 0 and 10000, where 0 represents 0%
