...
### `TARGET_VAULT · depositAndMintOsToken`

Stake ETH to the corresponding StakeWise v3 Vault and mints osToken shares to the specified receiver.

- **Contract:** `TARGET_VAULT`
- **Function:** `depositAndMintOsToken(address,uint256,address)` Ξ _allow sending ETH_
