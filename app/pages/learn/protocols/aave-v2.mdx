...
If the `AAVE` token is given as an element of `targets`, the following functions are allowed:
...
If the `ABPT` token is given as an element of `targets`, the following functions are allowed:
...
If the `stkAAVE` token is given as an element of `targets`, the following functions are allowed:
...
If the `aEthAAVE` token is given as an element of `targets`, the following functions are allowed:
