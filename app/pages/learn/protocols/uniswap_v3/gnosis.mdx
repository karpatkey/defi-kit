...
# Uniswap v3 on Gnosis Chain

**Deployments**

| Name           | Address                                                                                                               |
| :------------- | :-------------------------------------------------------------------------------------------------------------------- |
| `PositionsNFT` | [0xAE8fbE656a77519a7490054274910129c9244FA3](https://gnosisscan.io/address/0xAE8fbE656a77519a7490054274910129c9244FA3) |
...
<Callout type="info">
  For safety reasons and to prevent potential XDAI losses, sending XDAI directly
  is prohibited for any function. Instead, XDAI must be wrapped into WXDAI
...
- **Function:** `mint((address,address,uint24,int24,int24,uint256,uint256,uint256,uint256,address,uint256))` {/* Ξ _allow sending XDAI_ */}
...
- **Contract:** `PositionsNFT`
- **Function:** `increaseLiquidity((uint256,uint256,uint256,uint256,uint256,uint256))` {/* Ξ _allow sending XDAI_ */}
...
Refunds the unused XDAI to the sender address.

- **Contract:** `PositionsNFT`
- **Function:** `refundETH()` Ξ _allow sending XDAI_
...
Unwraps a specified amount of `WXDAI` and transfers the corresponding XDAI to the designated recipient address.
